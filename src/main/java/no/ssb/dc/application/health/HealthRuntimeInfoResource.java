...
public class HealthRuntimeInfoResource implements HealthResource {
    ...
    static class RuntimeInfo {
        @JsonProperty final int availableProcessors;
        @JsonProperty final long freeMemoryInMegaBytes;
        @JsonProperty final long maxMemoryInMegaBytes;
        @JsonProperty final long totalMemoryInMegaBytes;
