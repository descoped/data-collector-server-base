...
public class CORSHandler implements HttpHandler {
    ...
    private static final Set<HttpString> DEFAULT_ALLOW_HEADERS = Set.of(
            Headers.AUTHORIZATION, Headers.CONTENT_TYPE, Headers.RANGE);

    static final HttpString ACCESS_CONTROL_ALLOW_CREDENTIALS = new HttpString("Access-Control-Allow-Credentials");
    static final HttpString ACCESS_CONTROL_ALLOW_HEADERS = new HttpString("Access-Control-Allow-Headers");
    static final HttpString ACCESS_CONTROL_ALLOW_METHODS = new HttpString("Access-Control-Allow-Methods");
    static final HttpString ACCESS_CONTROL_ALLOW_ORIGIN = new HttpString("Access-Control-Allow-Origin");
    static final HttpString ACCESS_CONTROL_EXPOSE_HEADERS = new HttpString("Access-Control-Expose-Headers");
    static final HttpString ACCESS_CONTROL_MAX_AGE = new HttpString("Access-Control-Max-Age");
    ...
    private CORSHandler(HttpHandler next, HttpHandler fail, List<Pattern> originPatterns, boolean supportsCredential) {
    ...
    CORSHandler(HttpHandler next, List<Pattern> originPatterns, boolean supportsCredential,
